...
import { WrapText as LucideWrapText } from 'lucide-vue-next'
import { AlignLeft as LucideFloatLeft } from 'lucide-vue-next'
import { AlignRight as LucideFloatRight } from 'lucide-vue-next'
import { AlignJustify as LucideNoFloat } from 'lucide-vue-next'
import { Captions as LucideCaptions } from 'lucide-vue-next'
import { MoveDiagonal2 as LucideMoveDiagonal2 } from 'lucide-vue-next'
import { RotateCw as LucideRotateCw } from 'lucide-vue-next'
